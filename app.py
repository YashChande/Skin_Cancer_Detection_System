...
def setup_model_pth(path_to_pth_file, learner_name_to_load, classes):
    ...
    learn = cnn_learner(data, models.densenet169, model_dir=r'C:\Users\yashc\Desktop\ml mini project\models')
...
def model_predict(img):
    ...
    formatted_outputs = ["{:.1f}%".format(value) for value in [x * 320 for x in torch.nn.functional.softmax(outputs, dim=0)]]
    pred_probs = sorted(
